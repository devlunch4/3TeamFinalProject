...
public class Service extends ModelTestConfig{
	...
	public void selectFmanage() {
		...
		/***When***/
		List<FmanageVo> volist = fanalysisService.selectFmanage("brown");
		/***Then***/
	...
	public void avgFmanage() {
		...
		/***When***/
		msrrecVo = fanalysisService.avgFmanage(msrrecVo);
		/***Then***/
	...
	public void selectTempList() {
		...
		/***When***/
		List<MyMaxMrrecListVo> VoList = fanalysisService.selectTempList();
		/***Then***/
