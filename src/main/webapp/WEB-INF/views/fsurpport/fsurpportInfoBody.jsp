	...
	<div class="container-fluid">
		...
		<form>
			<div class="form-group">
				...
				<input class="form-control py-4" id="input_cls_code" name=""
					type="text" value="" required="required">
			</div>
			<div class="form-group">
				<label class="small mb-1" for="input_grdgd_nm">품목</label> 
				<input class="form-control py-4" id="input_grdgd_nm" name=""
					type="text" value="" required="required">
			</div>
			<div class="form-group">
				<label class="small mb-1" for="input_difficulty">작업단계</label> 
				<input class="form-control py-4" id="input_difficulty"
					name="" type="text" value="" required="required">
			</div>
			
			<div class="form-group">
				<label class="small mb-1" for="input_plant_prd">작업내용</label>
				<br>
				<textarea  rows="auto" cols="auto" name="" style="resize: none;"
			...
			<div class="form-group">
				...
				<input class="form-control py-4" id="input_plant_prd"
					name="" type="text" value="" required="required">
			</div>
