...
<div class="form-group">
	<label class="small mb-1" for="input_plant_prd">사진</label> <br> <img src="${pageContext.request.contextPath}/fsurpport/filePath?file_nm=${farmdiaryList.file_nm }" height="100px" alt="사진없음">
</div>
