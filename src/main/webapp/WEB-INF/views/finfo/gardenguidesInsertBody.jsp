				...
				<div class="col-md-3">
					<div class="form-group ">
						<label class="small mb-1" for="cls_code">분류명</label> <input
							class="form-control py-4" id="cls_code" name="cls_code"
				...
				<div class="col-md-3">
					<div class="form-group ">
						<label class="small mb-1" for="grdgd_nm">품목명</label> <input
							class="form-control py-4" id="grdgd_nm" name="grdgd_nm"
				...
				<div class="col-md-3">
					<div class="form-group">
						<label class="small mb-1" for="plant_prd">재배시기</label> <input
							...
							type="text" placeholder="재배시기 입력 ex)3월중순~6월하순"
							required="required">
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label class="small mb-1" for="grow_prd">재배기간</label> <input
							class="form-control py-4" id="grow_prd" name="grow_prd"
							type="text" placeholder="재배기간 입력 ex)3개월" required="required">
					</div>
				</div>
...
수분을 해 주면 열매 맺음이 좋다."
			...
			<div class="form-group">
				...
				<textarea class="form-control" id="plant_content"
					name="plant_content"
					placeholder="재배내용 ex)
...
▷ 호박은 사용 용도에 따라 애호박, 단호박, 맷돌호박, 꽃호박, 약호박 등 매우 다양하지만, 일반적으로 텃밭에서는 애호박과 호박잎을 이용하는 종류를 많이 재배한다."
			...
			<div class="form-group">
				<label class="small" for="file_nm">파일추가2</label> <input type="file"
					id="file_nm2" name="file_nm" accept="image/png, image/jpeg">
			</div>
	</div>
