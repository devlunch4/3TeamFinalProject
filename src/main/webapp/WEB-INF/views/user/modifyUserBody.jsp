...
// 	    		}
	    		...
	    		//빈칸 체크
    			if( $("#user_nm").val()!="" &&  $("#user_pw").val()!=""  && $("#confirm_user_pw").val()!=""  
	    		...
	    		//모든 정규식,미입력 등등 확인
	    		if(status_nm == 0 || status_pw == 0 || status_confirm_pw == 0 || status_mobile == 0 || status_mobile_btn == 0 || status_email == 0 || status_email_btn == 0){
	...
	<div class="row justify-content-center">
		<div class="col-lg-7">
			<div class="card shadow-lg border-0 rounded-lg mt-5">
				...
				<div class="card-body">
					<form id="frm" role="form" method="post" action="modifyUser3">
						...
						<div class="form-group">
							<label class="small mb-1" for="user_id">아이디<span class="red_star"> *</span></label> <input class="form-control py-4" id="user_id" readonly="readonly" name="user_id" type="text" placeholder="${S_USER.user_id }" value="${S_USER.user_id }"/>
							<p class="status_txt id_status"></p>
							<p class="id_status_ok status_ok"></p>
							<p class="id_status_taken"></p>
						</div>
						<div class="form-group">
							<label class="small mb-1" for="user_pw">비밀번호<span class="red_star"> *</span></label> <input class="form-control py-4" id="user_pw" name="user_pw" type="password" placeholder="비밀번호를 입력하세요." />
							<p class="status_txt pw_status"></p>
						</div>
						<div class="form-group">
							<label class="small mb-1" for="confirm_user_pw">비밀번호 확인<span class="red_star"> *</span></label> <input class="form-control py-4" id="confirm_user_pw" name="confirm_user_pw" type="password" placeholder="비밀번호 확인" />
						...
						<div class="form-row">
							<div class="col-md-8">
								<div class="form-group">
									<label class="small mb-1" for="mobile">핸드폰번호<span class="red_star"> *</span></label> <input class="form-control py-4" id="mobile" name="mobile" type="text" aria-describedby="전화번호" placeholder="핸드폰번호를 숫자만 입력하세요." />
						...
						<div class="form-group">
							<label class="small mb-1" for="addr1">주소</label> <input class="form-control py-4" id="addr1" name="addr1" type="text" aria-describedby="주소" placeholder="주소" readonly />
						</div>
						<div class="form-group">
