	...
	/* 	//이메일 인증코드 입력시
		...
		$("#btn_join").on(
				...
				function() {
					...
					//모든 정규식,미입력 등등 확인
					if (status_nm == 0 || status_pw == 0
							|| status_confirm_pw == 0 /* || status_mobile == 0
							|| status_mobile_btn == 0 || status_email == 0
							|| status_email_btn == 0 */) {
		...
		<div class="col-lg-7">
			<div class="card shadow-lg border-0 rounded-lg mt-5">
				<div class="card-header">
					<h3 class="text-center font-weight-light my-4">정보수정</h3>
				</div>

				<div class="card-body">
					<form id="frm" role="form" method="post" action="${pageContext.request.contextPath}/user/modifyUser3">
						<div class="form-group">
							<label class="small mb-1" for="user_nm">
								이름<span class="red_star"> *</span>
							</label>
							<input class="form-control py-4" id="user_nm" name="user_nm" type="text" placeholder="이름을 입력하세요." value="${S_USER.user_nm }"/>
							<p class="status_txt name_status"></p>
						</div>
						<div class="form-group">
							<label class="small mb-1" for="user_id">
								아이디<span class="red_star"> *</span>
							</label>
							<input class="form-control py-4" id="user_id" readonly="readonly" name="user_id" type="text" placeholder="${S_USER.user_id }" value="${S_USER.user_id }" />
							<p class="status_txt id_status"></p>
							<p class="id_status_ok status_ok"></p>
							<p class="id_status_taken"></p>
						</div>
						<div class="form-group">
							<label class="small mb-1" for="user_pw">
								비밀번호<span class="red_star"> *</span>
							</label>
							<input class="form-control py-4" id="user_pw" name="user_pw" type="password" placeholder="비밀번호를 입력하세요." value="${S_USER.user_pw }"/>
							<p class="status_txt pw_status"></p>
						</div>
						<div class="form-group">
							<label class="small mb-1" for="confirm_user_pw">
								비밀번호 확인<span class="red_star"> *</span>
							</label>
							<input class="form-control py-4" id="confirm_user_pw" name="confirm_user_pw" type="password" placeholder="비밀번호 확인" value="${S_USER.user_pw }"/>
						...
						<div class="form-row">
							<div class="col-md-8">
								<div class="form-group">
									<label class="small mb-1" for="mobile">
										핸드폰번호<span class="red_star"> *</span>
									</label>
									<input class="form-control py-4" id="mobile" name="mobile" type="text" aria-describedby="전화번호" placeholder="핸드폰번호를 숫자만 입력하세요." value="${S_USER.mobile }"/>
							...
							<!-- <div class="col-md-4">
								<div class="form-group">
									<label class="small mb-1 display-none-767">&nbsp;</label> <input class="btn btn-primary2 btn-block f-py-3" id="btn_mobile" type="button" value="인증하기" />
								</div>
							</div> -->
						</div>
						<!-- 	<div class="form-group">
						...
						<div class="form-row">
							<div class="col-md-8">
								<div class="form-group">
									...
									<input class="form-control py-4" id="email" name="email" type="email" aria-describedby="이메일" placeholder="이메일주소를 입력하세요." value="${S_USER.email }"/>
							...
							<!-- 							<div class="col-md-4">
								<div class="form-group">
									<label class="small mb-1 display-none-767">&nbsp;</label> <input class="btn btn-primary2 btn-block f-py-3" id="btn_email" type="button" value="인증하기" />
								</div>
							</div> -->
						</div>
						<!-- 						<div class="form-group">
						...
						<div class="form-group">
							...
							<input class="form-control py-4" id="addr1" name="addr1" type="text" aria-describedby="주소" placeholder="주소" readonly value="${S_USER.addr1}" />
						</div>
						<div class="form-group">
							<input class="form-control py-4" id="addr2" name="addr2" type="text" placeholder="상세주소" value="${S_USER.addr2 }"/>
						</div>

						<div class="form-row">
							<div class="col-md-8">
								<div class="form-group">
									<input class="form-control py-4" id="zip" name="zip" type="text" placeholder="우편번호" readonly value="${S_USER.zip }"/>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
						...
						<div class="form-group mt-4 mb-0">
							<button type="button" id="btn_join" class="btn btn-primary btn-block">수정완료</button>
