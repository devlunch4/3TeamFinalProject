							...
							<nav aria-label="member list Navigation">
								<ul class="pagination justify-content-center m-0">
									<li class="prev"><a class="page-link"
										href="${cp }/user/pagingUserSearch?page=1&pageSize=${pageVo.pageSize }&keyword=${keyword }&searchType=${searchType }"><i
											class="fas fa-angle-double-left"></i></a></li>

									<li class="page-item"><a class="page-link"
										href="${cp }/user/pagingUserSearch?page=<c:choose><c:when test="${pageVo.getPage()- 1 <= 0 }">1</c:when><c:otherwise>${pageVo.getPage()- 1}</c:otherwise>
									...
									<c:forEach begin="1" end="${pagination }" var="i">
										<c:choose>
											...
											<c:otherwise>
												<li class="page-item"><a class="page-link"
													href="${cp }/user/pagingUserSearch?page=${i }&pageSize=${pageVo.pageSize }&keyword=${keyword }&searchType=${searchType }">${i }
												</a></li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									...
									<li class="page-item"><a class="page-link"
										href="${cp }/user/pagingUserSearch?page=
<c:choose>
...
<c:otherwise>${pageVo.getPage()+ 1}</c:otherwise>
									...
									<li class="next"><a class="page-link"
										href="${cp }/user/pagingUserSearch?page=${pagination }&pageSize=${pageVo.pageSize }&keyword=${keyword }&searchType=${searchType }"><i
