	...
	<!-- Navbar -->
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="${cp }/user/main"
					class="nav-link">Main</a></li>
				<li class="nav-item d-none d-sm-inline-block"><a href="${cp }/user/allUser"
					class="nav-link">회원 한페이지로 보기</a></li>
				<li class="nav-item d-none d-sm-inline-block"><a href="${cp }/user/pagingUser"
