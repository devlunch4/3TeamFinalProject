	...
	<div class="sb-sidenav-menu">
		<div class="nav">
			...
			<div class="collapse" id="collapseLayouts3" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
				<nav class="sb-sidenav-menu-nested nav">
					<a class="nav-link" href="${pageContext.request.contextPath }/qna/view">문의사항</a> <a class="nav-link" href="${pageContext.request.contextPath }/fnotice/noticesView">공지사항</a> <a class="nav-link" href="${pageContext.request.contextPath }/market/minimarketView">미니장터</a>
				</nav>
			</div>
		</div>
	</div>
