	...
	<div class="sb-sidenav-menu">
		<div class="nav">
			...
			<div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
				<nav class="sb-sidenav-menu-nested nav">
					<a class="nav-link" href="${pageContext.request.contextPath}/finfo/gardenguides">텃밭가이드</a> <a class="nav-link" href="${pageContext.request.contextPath}/finfo/seasonInfos">제철작물</a>
					<%-- <a class="nav-link" href="${pageContext.request.contextPath}/finfo/raceInfosView">품종정보</a> --%>
					<a class="nav-link" href="${pageContext.request.contextPath}/finfo/weeklyFarmInfosView">주간 농사정보</a> <a class="nav-link" href="${pageContext.request.contextPath}/finfo/itemFarmManualsView">품목별 영농매뉴얼</a>
				</nav>
			</div>
			...
			<div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
				<nav class="sb-sidenav-menu-nested nav">
					<a class="nav-link" href="${pageContext.request.contextPath}/fsurpport/main?user_id=${S_USER.user_id}">영농일지</a> <a class="nav-link" href="${pageContext.request.contextPath }/fsurpport/fmanageList">시설관리</a> <a class="nav-link" href="${pageContext.request.contextPath }/fsurpport/msrequipList">장비관리</a>
				</nav>
			...
			<div class="collapse" id="collapseLayouts3" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
				<nav class="sb-sidenav-menu-nested nav">
					<a class="nav-link" href="${pageContext.request.contextPath }/qna/view">문의사항</a> <a class="nav-link" href="${pageContext.request.contextPath }/fnotice/noticesView">공지사항</a> <a class="nav-link" href="${pageContext.request.contextPath }/fcommunity/miniMarketView">미니장터</a>
				</nav>
			</div>
